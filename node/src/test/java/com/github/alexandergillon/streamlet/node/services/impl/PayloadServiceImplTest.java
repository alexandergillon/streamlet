...
class PayloadServiceImplTest {
    ...
    public void testPayloadOrderImmediateFinalization() {
        assertNull(payloadService.getNextPayload(new ArrayList<>()));
        ...
        assertArrayEquals(message1.toStringBytes(), payloadService.getNextPayload(new ArrayList<>()));
        payloadService.finalizedPayload(message1.toStringBytes());
        assertArrayEquals(message2.toStringBytes(), payloadService.getNextPayload(new ArrayList<>()));
        payloadService.finalizedPayload(message2.toStringBytes());
        assertArrayEquals(message3.toStringBytes(), payloadService.getNextPayload(new ArrayList<>()));
        payloadService.finalizedPayload(message3.toStringBytes());
        assertArrayEquals(message4.toStringBytes(), payloadService.getNextPayload(new ArrayList<>()));
        payloadService.finalizedPayload(message4.toStringBytes());
        assertArrayEquals(message5.toStringBytes(), payloadService.getNextPayload(new ArrayList<>()));
    ...
    public void testPayloadOrderWithUnfinalizedChains() {
        ...
        assertArrayEquals(message1.toStringBytes(), payloadService.getNextPayload(new ArrayList<>()));
        assertArrayEquals(message2.toStringBytes(), payloadService.getNextPayload(List.of(blockWithMessage1)));
        assertArrayEquals(message3.toStringBytes(), payloadService.getNextPayload(Arrays.asList(blockWithMessage1, blockWithMessage2)));
        assertArrayEquals(message4.toStringBytes(), payloadService.getNextPayload(Arrays.asList(blockWithMessage1, blockWithMessage2, blockWithMessage3)));
        assertArrayEquals(message5.toStringBytes(), payloadService.getNextPayload(Arrays.asList(blockWithMessage1, blockWithMessage2, blockWithMessage3, blockWithMessage4)));
        assertNull(payloadService.getNextPayload(Arrays.asList(blockWithMessage1, blockWithMessage2, blockWithMessage3, blockWithMessage4, blockWithMessage5)));

        assertArrayEquals(message1.toStringBytes(), payloadService.getNextPayload(Arrays.asList(blockWithMessage2, blockWithMessage3)));

        payloadService.finalizedPayload(message2.toStringBytes());

        assertArrayEquals(message1.toStringBytes(), payloadService.getNextPayload(new ArrayList<>()));
        assertArrayEquals(message3.toStringBytes(), payloadService.getNextPayload(List.of(blockWithMessage1)));
        assertArrayEquals(message4.toStringBytes(), payloadService.getNextPayload(Arrays.asList(blockWithMessage1, blockWithMessage3)));
        assertArrayEquals(message5.toStringBytes(), payloadService.getNextPayload(Arrays.asList(blockWithMessage1, blockWithMessage3, blockWithMessage4)));
        assertNull(payloadService.getNextPayload(Arrays.asList(blockWithMessage1, blockWithMessage3, blockWithMessage4, blockWithMessage5)));
    }
